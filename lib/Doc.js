...
class Doc {
  ...
  getDocData(data, callback) {
    if (typeof this.idValue === 'undefined') {
      callback('Get doc data error: setIdValue(args) is undefined.', null);
    }
    if (typeof this.idField === 'undefined') {
      callback('Get doc data error: setIdField(args) is undefined.', null);
    }
    if (typeof this.table === 'undefined') {
      callback('Get doc data error: setTable(args) is undefined.', null);
    }
  ...
  renderDoc(callback) {
    if (typeof this.idField === 'undefined') {
      callback('Render doc error: setIdField(args) is undefined.', null);
    }
    if (typeof this.docData === 'undefined') {
      callback('Render doc error: setDocData(args) is undefined.', null);
    }
    if (typeof this.table === 'undefined') {
      callback('Render doc error: setTable(args) is undefined.', null);
    }
    if (typeof this.dir === 'undefined') {
      callback('Get doc data error: setDir(args) is undefined.', null);
    }

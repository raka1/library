...
class Abstract {
  ...
  setTable(data) {
    ...
    if (typeof this.idValue === 'undefined') {
      callback('Get error: setIdValue(args) is undefined.', null);
    }
    if (typeof this.idField === 'undefined') {
      callback('Get error: setIdField(args) is undefined.', null);
    }
    if (typeof this.descField === 'undefined') {
      callback('Get error: setDescField(args) is undefined.', null);
    }
    if (typeof this.table === 'undefined') {
      callback('Get error: setTable(args) is undefined.', null);
    }
    let style = '';
    let font = '';
    let fontFace = '';

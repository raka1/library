...
class DocServe {
  ...
  renderListView(callback) {
    if (typeof this.idField === 'undefined') {
      callback('Render view list error: setIdField(args) is undefined.', null);
    }
    if (typeof this.field === 'undefined') {
      callback('Render view list error: setField(args) is undefined.', null);
    }
    if (typeof this.target === 'undefined') {
      callback('Render view list error: setTarget(args) is undefined.', null);
    }
    if (typeof this.table === 'undefined') {
      callback('Render view list error: setTable(args) is undefined.', null);
    }
